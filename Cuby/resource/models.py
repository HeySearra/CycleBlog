...
class Resource(models.Model):
    ...
    upload_time = models.DateTimeField(blank=True, verbose_name='上传时间', auto_now_add=True)
    edit_time = models.DateTimeField(blank=True, verbose_name='修改时间', auto_now=True)
    author_name = models.ForeignKey(null=True, to='user.User', related_name="resource_author", on_delete=models.CASCADE)  # todo: ForeignKey是null=True还是blank=True？
    blocked = models.BooleanField(blank=True, verbose_name='被封禁', default=False)
