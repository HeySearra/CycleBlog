<template>
    <div style="padding:10px 30px">
        <div>
            ...
            <rsb type="download" :rid="item" v-for="item in list" :key="item" ref="rsb" @refresh="refresh" @done="loading_done_msg"></rsb>
        </div>
...
export default {
    ...
    methods:{
        ...
        apply_for_info(){
            ...
            $.ajax({ 
                type:'get', 
                url:'/create/resource/download_list?page='+that.current_page+'&each='+that.page_size,
